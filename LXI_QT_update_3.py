...
#
# Created: Tue Jul 11 18:28:40 2023
...
"background-color: rgb(0, 0, 0);")
        ...
        self.frame_11.setMinimumSize(QtCore.QSize(0, 83))
        self.frame_11.setStyleSheet("background-color: rgb(152, 152, 152);")
        ...
        self.label_3.setGeometry(QtCore.QRect(10, 10, 161, 61))
        ...
        self.maintab.setMinimumSize(QtCore.QSize(1349, 652))
...
"background-color: rgb(0, 0, 0);")
        ...
        self.splitter.setGeometry(QtCore.QRect(0, 10, 1351, 527))
        ...
        self.frame_6.setMinimumSize(QtCore.QSize(339, 0))
        ...
        self.scrollArea_PCI = QtGui.QScrollArea(self.frame_10)
        self.scrollArea_PCI.setMinimumSize(QtCore.QSize(651, 82))
        self.scrollArea_PCI.setStyleSheet("background-color: rgb(152, 152, 152);")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 708, 105))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_PCI.sizePolicy().hasHeightForWidth())
        self.pushButton_PCI.setSizePolicy(sizePolicy)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.pushButton_open_PCI.setDefault(False)
        self.pushButton_open_PCI.setFlat(False)
        ...
        self.verticalLayout_9.addWidget(self.scrollArea_PCI)
        ...
        self.scrollArea_PXI = QtGui.QScrollArea(self.frame_7)
        self.scrollArea_PXI.setMinimumSize(QtCore.QSize(651, 82))
        self.scrollArea_PXI.setStyleSheet("background-color: rgb(152, 152, 152);")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 706, 105))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.pushButton_open_PXI.setDefault(False)
        self.pushButton_open_PXI.setFlat(False)
        ...
        self.verticalLayout_10.addWidget(self.scrollArea_PXI)
        ...
        self.scrollArea_LXI = QtGui.QScrollArea(self.frame_9)
        self.scrollArea_LXI.setMinimumSize(QtCore.QSize(651, 82))
        self.scrollArea_LXI.setStyleSheet("background-color: rgb(152, 152, 152);")
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 706, 105))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.pushButton_open_LXI.setDefault(False)
        self.pushButton_open_LXI.setFlat(False)
        ...
        self.verticalLayout_11.addWidget(self.scrollArea_LXI)
        self.verticalLayout_8.addWidget(self.frame_9)
        self.frame_8 = QtGui.QFrame(self.frame_6)
        self.frame_8.setMinimumSize(QtCore.QSize(0, 199))
        self.frame_8.setStyleSheet("background-color: rgb(152, 152, 152);")
        ...
        self.frame_display = QtGui.QFrame(self.splitter)
        ...
        self.frame_display.setMinimumSize(QtCore.QSize(600, 400))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_details.sizePolicy().hasHeightForWidth())
        self.label_details.setSizePolicy(sizePolicy)
        self.label_details.setMinimumSize(QtCore.QSize(600, 0))
        font = QtGui.QFont()
        ...
        self.frame_2.setStyleSheet("background-color: rgb(152, 152, 152);")
        ...
        self.pushButton_refresh.setStyleSheet("background-color: rgb(255, 255, 255);")
...
"background-color: rgb(255, 255, 255);")
        ...
        self.progressBar = QtGui.QProgressBar(self.frame_5)
...
"            }")
        ...
        self.verticalLayout_13.addWidget(self.maintab)
