...
# Form implementation generated from reading ui file 'LXI_QT_update_5.ui'
#
# Created: Thu Jul 13 11:51:48 2023
...
class Ui_MainWindo(object):
    def setupUi(self, MainWindo):
        ...
        self.widget.setGeometry(QtCore.QRect(0, 0, 1364, 91))
        ...
        self.label_3.setGeometry(QtCore.QRect(40, 16, 141, 51))
        ...
        self.label_header_info = QtGui.QLabel(self.frame_2)
        self.label_header_info.setGeometry(QtCore.QRect(1210, 10, 141, 61))
        self.label_header_info.setStyleSheet("color: rgb(0, 0, 255);")
        self.label_header_info.setObjectName("label_header_info")
        self.label = QtGui.QLabel(self.frame_2)
        self.label.setGeometry(QtCore.QRect(183, 43, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setWeight(75)
        font.setBold(True)
        ...
        self.line.setGeometry(QtCore.QRect(0, 84, 1366, 15))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.maintab.setGeometry(QtCore.QRect(0, 100, 1364, 614))
        self.maintab.setMinimumSize(QtCore.QSize(1351, 611))
        self.maintab.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.maintab.setObjectName("maintab")
        self.tab = QtGui.QWidget()
        self.tab.setObjectName("tab")
        self.widget_2 = QtGui.QWidget(self.tab)
        self.widget_2.setGeometry(QtCore.QRect(-9, -8, 1364, 511))
        self.widget_2.setStyleSheet("\n"
"background-color: rgb(0, 0, 0);")
        self.widget_2.setObjectName("widget_2")
        self.frame_display = QtGui.QFrame(self.widget_2)
        self.frame_display.setGeometry(QtCore.QRect(684, 10, 681, 501))
        self.frame_display.setStyleSheet("background-color: rgb(180, 180, 180);")
        ...
        self.horizontalLayout = QtGui.QHBoxLayout(self.frame_display)
        ...
        self.label_details.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.label_details.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        ...
        self.scrollArea_LXI.setStyleSheet("background-color: rgb(180, 180, 180);")
        self.scrollArea_LXI.setFrameShape(QtGui.QFrame.WinPanel)
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 668, 111))
...
"")
        ...
        self.frame_LXI.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.scrollArea_PCI.setStyleSheet("background-color: rgb(180, 180, 180);")
        self.scrollArea_PCI.setFrameShape(QtGui.QFrame.WinPanel)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 668, 111))
...
"")
        ...
        self.frame_PCI.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.scrollArea_PXI.setStyleSheet("background-color: rgb(180, 180, 180);")
        self.scrollArea_PXI.setFrameShape(QtGui.QFrame.WinPanel)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 668, 111))
...
"")
        ...
        self.frame_pxi.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 356, 672, 154))
        font = QtGui.QFont()
        ...
        self.frame_3.setGeometry(QtCore.QRect(1, 504, 1353, 82))
        ...
        self.pushButton_add = QtGui.QPushButton(self.frame_3)
        self.pushButton_add.setGeometry(QtCore.QRect(456, 10, 75, 23))
        ...
        self.lineEdit_search = QtGui.QLineEdit(self.frame_3)
        self.lineEdit_search.setGeometry(QtCore.QRect(220, 10, 222, 21))
        ...
        self.pushButton_refresh = QtGui.QPushButton(self.frame_3)
        self.pushButton_refresh.setGeometry(QtCore.QRect(130, 10, 75, 23))
        ...
        self.progressBar.setGeometry(QtCore.QRect(5, 44, 1381, 23))
...
"background-color: rgb(240, 80, 0);")
        ...
        spacerItem = QtGui.QSpacerItem(1141, 16, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
...
"            }")
    ...
    def retranslateUi(self, MainWindo):
        ...
        self.label_header_info.setText(QtGui.QApplication.translate("MainWindo", "                      ", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("MainWindo", " VigVen Interfaces\n"
"                 General SFP", None, QtGui.QApplication.UnicodeUTF8))
